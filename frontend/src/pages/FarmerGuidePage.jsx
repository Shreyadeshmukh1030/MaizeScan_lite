...
const translations = {
    en: {
        title: "System Manual & Documentation",
        ...
        tab4: "Defect Library",
        tab5: "Video Guides",
        tab6: "Operating Manual",
        tab7: "System Pipeline",
        tab8: "Dataset & Purpose",
...
const FarmerGuidePage = () => {
    ...
    const tabs = [
        ...
        { id: 'Manual', label: t.tab6 || "Operating Manual", icon: <BookOpen size={18} /> },
        { id: 'Architecture', label: t.tab7 || "System Pipeline", icon: <Zap size={18} /> },
        { id: 'Dataset', label: t.tab8 || "Dataset & Purpose", icon: <FileText size={18} /> },
                        ...
                        <div className="glass-panel" style={{ padding: '3rem' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                <div>
                                    ...
                                    <p style={{ color: 'var(--text-light)', fontSize: '1.1rem' }}>Navigate to the Live Inspection page. Grant camera permissions or upload an image directly from your device. The AI engine automatically detects and draws bounding boxes around maize seeds in real-time.</p>
                                </div>
                                <div>
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--primary)' }}>2. AI Sensitivity Slider</h3>
                                    <p style={{ color: 'var(--text-light)', fontSize: '1.1rem' }}>Use the sensitivity slider on the right panel to adjust the confidence threshold. If the lighting is poor and seeds are not being detected, lower the sensitivity to ~20%. If false positives appear, increase the sensitivity.</p>
                                </div>
                                <div>
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--primary)' }}>3. Understanding Telemetry</h3>
                                    <p style={{ color: 'var(--text-light)', fontSize: '1.1rem' }}>The left panel provides real-time analytics. It calculates the overall batch grade (A, B, C) based on the ratio of excellent/good seeds versus bad/shriveled/moldy seeds.</p>
                                </div>
                                <div>
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--primary)' }}>4. Digital Certificates</h3>
                                    <p style={{ color: 'var(--text-light)', fontSize: '1.1rem' }}>Once an inspection is completed, it is saved to the database. Navigate to the Reports page to view the history and generate a Digital Quality Certificate for any batch.</p>
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '1rem' }}>
                                <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center' }}>
                                    <img src="/images/dataset_samples/dataset_excellent.png" alt="Excellent" style={{ width: '100%', borderRadius: '1rem', height: '150px', objectFit: 'cover' }} />
                                    <div style={{ fontWeight: 800, marginTop: '1rem', color: '#059669' }}>Excellent</div>
                                </div>
                                <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center' }}>
                                    <img src="/images/dataset_samples/dataset_good.png" alt="Good" style={{ width: '100%', borderRadius: '1rem', height: '150px', objectFit: 'cover' }} />
                                    <div style={{ fontWeight: 800, marginTop: '1rem', color: '#0ea5e9' }}>Good</div>
                                </div>
                                <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center' }}>
                                    <img src="/images/dataset_samples/dataset_average.png" alt="Average" style={{ width: '100%', borderRadius: '1rem', height: '150px', objectFit: 'cover' }} />
                                    <div style={{ fontWeight: 800, marginTop: '1rem', color: '#eab308' }}>Average</div>
                                </div>
                                <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center' }}>
                                    <img src="/images/dataset_samples/dataset_bad.png" alt="Bad" style={{ width: '100%', borderRadius: '1rem', height: '150px', objectFit: 'cover' }} />
                                    <div style={{ fontWeight: 800, marginTop: '1rem', color: '#f97316' }}>Bad</div>
                                </div>
                                <div className="glass-panel" style={{ padding: '1rem', textAlign: 'center' }}>
                                    <img src="/images/dataset_samples/dataset_worst.png" alt="Worst" style={{ width: '100%', borderRadius: '1rem', height: '150px', objectFit: 'cover' }} />
